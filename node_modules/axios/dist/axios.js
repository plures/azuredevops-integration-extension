...
(function (global, factory) {
                ...
                for (_iterator.s(); !(_step = _iterator.n()).done; ) {
                  ...
                  obj[(key = entry[0])] = (dest = obj[key])
                    ? utils$1.isArray(dest)
                      ? [].concat(_toConsumableArray(dest), [entry[1]])
                      : [dest, entry[1]]
                    : entry[1];
                }
              } catch (err) {
  ...
  var CanceledError = /*#__PURE__*/ (function (_AxiosError) {
    ...
    function CanceledError(message, config, request) {
      ...
      _this = _callSuper(this, CanceledError, [
  ...
  function mergeConfig(config1, config2) {
    ...
    utils$1.forEach(
      Object.keys(_objectSpread2(_objectSpread2({}, config1), config2)),
    ...
    function (config) {
      return new Promise(function dispatchXhrRequest(resolve, reject) {
        ...
        function onloadend() {
          ...
          var responseHeaders = AxiosHeaders.from(
    ...
    if (timeout || length) {
      ...
      var timer =
        ...
        setTimeout(function () {
          timer = null;
          onabort(
            new AxiosError('timeout of '.concat(timeout, 'ms exceeded'), AxiosError.ETIMEDOUT)
          );
        }, timeout);
  ...
  var readBytes = /*#__PURE__*/ (function () {
    var _ref = _wrapAsyncGenerator(
      /*#__PURE__*/ _regenerator().m(function _callee(iterable, chunkSize) {
            ...
            while (1)
              switch ((_context2.p = _context2.n)) {
                ...
                case 3:
                  ...
                  return _context2.d(
                    _regeneratorValues(
                      _asyncGeneratorDelegate(_asyncIterator(streamChunk(chunk, chunkSize)))
                    ),
                    4
                  );
                case 4:
  ...
  var readStream = /*#__PURE__*/ (function () {
    var _ref2 = _wrapAsyncGenerator(
      /*#__PURE__*/ _regenerator().m(function _callee2(stream) {
            ...
            while (1)
              switch ((_context3.p = _context3.n)) {
                case 0:
                  ...
                  return _context3.d(
                    _regeneratorValues(_asyncGeneratorDelegate(_asyncIterator(stream))),
                    1
                  );
                case 1:
  ...
  var factory = function factory(env) {
      ...
      (typeof TextEncoder === 'function'
        ...
        : /*#__PURE__*/ (function () {
            var _ref2 = _asyncToGenerator(
              /*#__PURE__*/ _regenerator().m(function _callee(str) {
                var _t, _t2;
                return _regenerator().w(function (_context) {
                  while (1)
                    switch (_context.n) {
    ...
    isFetchSupported &&
      (function () {
        ['text', 'arrayBuffer', 'blob', 'formData', 'stream'].forEach(function (type) {
          !resolvers[type] &&
            (resolvers[type] = function (res, config) {
    ...
    var getBodyLength = /*#__PURE__*/ (function () {
      var _ref3 = _asyncToGenerator(
        /*#__PURE__*/ _regenerator().m(function _callee2(body) {
          var _request;
    ...
    var resolveBodyLength = /*#__PURE__*/ (function () {
      var _ref4 = _asyncToGenerator(
        /*#__PURE__*/ _regenerator().m(function _callee3(headers, body) {
          var length;
    ...
    return /*#__PURE__*/ (function () {
      var _ref5 = _asyncToGenerator(
        /*#__PURE__*/ _regenerator().m(function _callee4(config) {
          var _resolveConfig,
            url,
            method,
            data,
                ...
                switch ((_context4.p = _context4.n)) {
                  case 0:
                    ((_resolveConfig = resolveConfig(config)),
                      ...
                      (withCredentials =
                        _resolveConfig$withCr === void 0 ? 'same-origin' : _resolveConfig$withCr),
                      (fetchOptions = _resolveConfig.fetchOptions));
                    _fetch = envFetch || fetch;
                    responseType = responseType ? (responseType + '').toLowerCase() : 'text';
                    composedSignal = composeSignals(
                  ...
                  case 4:
                    ...
                    resolvedOptions = _objectSpread2(
                  ...
                  case 8:
                    ...
                    unsubscribe && unsubscribe();
                    if (
                      !(_t5 && _t5.name === 'TypeError' && /Load failed|fetch/i.test(_t5.message))
                    ) {
                      _context4.n = 9;
                      break;
                    }
    ...
    return _createClass(Axios, [
      {
        ...
        value: (function () {
          var _request2 = _asyncToGenerator(
            /*#__PURE__*/ _regenerator().m(function _callee(configOrUrl, config) {
      ...
      },
      {
        ...
        value: function _request(configOrUrl, config) {
          ...
          this.interceptors.request.forEach(function unshiftRequestInterceptors(interceptor) {
            ...
            var legacyInterceptorReqResOrdering =
