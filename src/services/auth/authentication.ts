...
/**
 * Create device code callback handler
 */
function createDeviceCodeCallback(options: GetEntraIdTokenOptions) {
...
async function acquireTokenByDeviceCode(
  ...
  const deviceCodeRequest = {
    deviceCodeCallback: createDeviceCodeCallback(options),
    scopes,
  };
