...
- The "Generate Copilot prompt" button from the final "Apply Time" dialog was removed. This functionality is now surfaced earlier in the "Stop Timer" quick pick menu, in preparation for tighter AI integration in future versions.
