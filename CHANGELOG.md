...
- build(deps): bump @plures/praxis in /apps/app-desktop (#252) (a4bb80e6)
- build(deps): bump @azure/msal-node from 3.8.4 to 5.4.1 (#250) (0b750b96)
- build(deps-dev): bump @eslint/json from 0.14.0 to 2.0.1 (#248) (8190317f)
- build(deps): bump actions/setup-node from 4 to 7 (#246) (37fefc87)
- build(deps-dev): bump lint-staged from 16.2.7 to 17.0.8 (#242) (15a53717)
- build(deps-dev): bump @eslint/css from 0.14.1 to 1.4.0 (#234) (8e978e92)
- build(deps): bump tauri-plugin-dialog in /apps/app-desktop/src-tauri (#215) (8789c9bc)
- build(deps-dev): bump markdown-it from 14.1.0 to 14.3.0 (#210) (564fdb89)
- build(deps): bump tauri-plugin-opener in /apps/app-desktop/src-tauri (#206) (7ebf33ff)
- build(deps): bump serde_json in /apps/app-desktop/src-tauri (#205) (713d3e14)
- fix(ci): restore green main (lockfile detection + lint) (#255) (9b2251d8)
- ci: migrate Tech Doc Writer to shared reusable (1cd52dbf)
- build(deps): bump tauri (#254) (f7a7c58b)
- build(deps): bump log in /apps/app-desktop/src-tauri (#209) (5b0295bb)
- build(deps): bump serde_with (#245) (95e68a66)
- build(deps): bump tauri-plugin-fs in /apps/app-desktop/src-tauri (#212) (baaf011e)
- build(deps): bump tauri-plugin-store in /apps/app-desktop/src-tauri (#207) (d94e5853)
- build(deps-dev): bump undici from 7.24.1 to 7.28.0 (#208) (dc5f35bf)
- build(deps): bump fast-uri from 3.1.0 to 3.1.3 (#216) (35e6207b)
- build(deps): bump tauri-plugin-updater in /apps/app-desktop/src-tauri (#218) (077f1bb1)
- build(deps): bump js-yaml from 4.1.1 to 4.3.0 (#220) (8a457c92)
- build(deps): bump actions/checkout from 4 to 7 (#228) (6513f8d1)
- build(deps): bump peter-evans/repository-dispatch from 3 to 4 (#229) (3df3594f)
- build(deps): bump actions/github-script from 7 to 9 (#230) (39e44d38)
- build(deps): bump dependabot/fetch-metadata from 2 to 3 (#232) (c852c265)
- build(deps-dev): bump @vscode/test-electron from 2.5.2 to 3.0.0 (#251) (bbb2f773)
- build(deps-dev): bump @eslint/markdown from 7.5.1 to 8.0.3 (#249) (18452db8)
- build(deps): bump the npm-minor-patch group across 1 directory with 6 updates (#247) (8d4bf5c6)
- build(deps-dev): bump @commitlint/cli from 20.2.0 to 21.2.1 (#243) (9ef1c32c)
- build(deps-dev): bump @babel/core in /apps/app-desktop (#244) (ef8f1875)
- build(deps-dev): bump @eslint/js from 9.39.2 to 10.0.1 (#239) (5c39c8b0)
- build(deps-dev): bump @types/node from 25.0.3 to 26.1.1 (#241) (a329a03a)
- build(deps-dev): bump eslint from 9.39.2 to 10.7.0 (#238) (da28464c)
- build(deps-dev): bump @commitlint/config-conventional (#237) (6a2a23f6)
- build(deps-dev): bump @sveltejs/vite-plugin-svelte from 6.2.1 to 7.2.0 (#236) (0bdd45ea)
- build(deps-dev): bump globals from 16.5.0 to 17.7.0 (#235) (b6b8156c)
- build(deps): bump the npm-minor-patch group across 1 directory with 6 updates (#233) (f959a0b5)
- fix(ci): repair tech-doc-writer YAML indentation / remove empty workflow (ca2f3c82)
- build(deps-dev): bump tmp from 0.2.5 to 0.2.7 (#219) (366878e3)
- build(deps): bump form-data from 4.0.5 to 4.0.6 in /mcp-server (#225) (80fdbea3)
- build(deps): bump form-data from 4.0.5 to 4.0.6 (#214) (ca49d7ed)
- build(deps-dev): bump vite from 7.3.2 to 7.3.6 (#227) (633476a0)
- build(deps): bump the npm-minor-patch group across 2 directories with 22 updates (#223) (07479dc7)
- ci(dependabot): v3 - do not auto-merge pre-1.0 (0.x) breaking bumps (0.x minor is breaking; aes-gcm 0.10->0.11 broke main) (2d094251)
- ci(dependabot): auto-merge security advisories regardless of semver bump (security over function) (3d3447a0)
- build(deps): bump tar (#204) (cd305109)
- fix(dependabot): replace broken empty-ecosystem stub with real config (63ea7552)
- build(deps): bump the npm_and_yarn group across 2 directories with 1 update (#202) (29aaf43d)
- ci: change release trigger from push-to-main to tag-only (2d5e783d)
- refactor: replace inline lifecycle with reusable workflow call (d49c149a)
- docs: refresh ROADMAP.md with OASIS strategic alignment (1f736087)
- docs: update copilot-instructions with praxis, design-dojo, automation rules (f0d491d4)
- build(deps): bump rustls-webpki (#201) (0318ad45)
- build(deps): bump the npm_and_yarn group across 2 directories with 1 update (#200) (9760557b)
- feat(release): add target_version input for milestone-driven releases (a66df234)
