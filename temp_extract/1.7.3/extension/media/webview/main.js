...
function updateTimerDisplay() {
  ...
  if (info)
    info.textContent = currentTimer.workItemTitle
      ? `#${currentTimer.workItemId} \xB7 ${currentTimer.workItemTitle}`
          ...
          <div class="work-item-details">
            ...
            ${
              assignedTo && assignedTo !== 'Unassigned'
                ? `<div class="work-item-assignee"><span class="assignee-icon">\u{1F464}</span><span>${escapeHtml(
                    String(assignedTo)
                  )}</span></div>`
                : ''
            }
            ${
              iterationPath
                ? `<div class="work-item-iteration"><span class="iteration-icon">\u{1F504}</span><span>${escapeHtml(
                  ...
                  <div class="kanban-card ${isSelected ? 'selected' : ''} ${hasActiveTimer ? 'has-active-timer' : ''}" data-id="${id}" data-action="selectWorkItem">
                    ...
                    <div class="kanban-card-content">
                      ...
                      <div class="kanban-card-meta">
                        ...
                        ${
                          assignedTo && assignedTo !== 'Unassigned'
                            ? `<span class="work-item-assignee"><span class="assignee-icon">\u{1F464}</span>${escapeHtml(
